...
def test_patient_access_own_data():
    ...
    try:
        ...
        patient = Patient.objects.create(
            first_name="RBACTest", last_name="OwnData", patient_id="RBAC-001"
        )
...
def test_patient_cannot_access_other_data():
    ...
    try:
        ...
        patient1 = Patient.objects.create(
            first_name="RBACTest", last_name="Patient1", patient_id="RBAC-002"
        )
        patient2 = Patient.objects.create(
            first_name="RBACTest", last_name="Patient2", patient_id="RBAC-003"
        )
...
def test_patient_read_only():
    ...
    try:
        patient = Patient.objects.create(
            first_name="RBACTest", last_name="ReadOnly", patient_id="RBAC-004"
        )
        user = User.objects.create_user(
...
def test_staff_access_all():
    ...
    try:
        patient = Patient.objects.create(
            first_name="RBACTest", last_name="StaffAccess", patient_id="RBAC-005"
        )
        doctor = User.objects.create_user(
            username="rbac_test_doctor@example.com", password="pass", role="DOCTOR"
        )
        visit = Visit.objects.create(patient=patient, status="OPEN")
        ...
        print("  Can access any patient's data: Yes")
...
def test_queryset_filtering():
    ...
    try:
        # Setup
        patient1 = Patient.objects.create(
            first_name="RBACTest", last_name="Filter1", patient_id="RBAC-006"
        )
        patient2 = Patient.objects.create(
            first_name="RBACTest", last_name="Filter2", patient_id="RBAC-007"
        )
...
def test_portal_access_permission():
    ...
    try:
        patient = Patient.objects.create(
            first_name="RBACTest", last_name="PortalAccess", patient_id="RBAC-008"
        )
        ...
        # Doctor user
        doctor = User.objects.create_user(
            username="rbac_test_doctor2@example.com", password="pass", role="DOCTOR"
        )
