...
def with_tenant_permissions(*permission_classes):
    ...
    defined; use this to keep IsAuthenticated + RequiresOrganization in SaaS mode.
    """
...
class RequiresOrganization(permissions.BasePermission):
    """
    Production SaaS: authenticated requests must resolve a tenant organization.
    ...
    EXEMPT_PATH_PREFIXES = (
        ...
        "/api/v1/subscriptions/flutterwave/webhook/",
        "/api/v1/health/",
    )
