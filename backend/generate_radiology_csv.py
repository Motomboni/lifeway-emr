...
services = [
    (
        ...
        "Chest X-Ray PA",
        "7500.00",
        "X-ray imaging of the chest in posteroanterior view",
    ),
    (
        "RAD-XRAY-CHEST-LAT",
        "Chest X-Ray Lateral",
        "7500.00",
        "X-ray imaging of the chest in lateral view",
    ),
    (
        "RAD-XRAY-SKULL",
        "Skull X-Ray",
        "8500.00",
        "X-ray imaging of the skull - 2 views",
    ),
    ...
    (
        ...
        "9000.00",
        "X-ray imaging of the cervical spine - 2 views",
    ),
    (
        "RAD-XRAY-SPINE-THOR",
        "Thoracic Spine X-Ray",
        "9500.00",
        "X-ray imaging of the thoracic spine - 2 views",
    ),
    (
        "RAD-XRAY-SPINE-LUMB",
        "Lumbar Spine X-Ray",
        "10000.00",
        "X-ray imaging of the lumbar spine - 2 views",
    ),
    (
        "RAD-XRAY-SHOULDER",
        "Shoulder X-Ray",
        "8500.00",
        "X-ray imaging of the shoulder joint",
    ),
    ...
    (
        "RAD-CT-HEAD-CONTRAST",
        "CT Scan Head with Contrast",
        "45000.00",
        "CT scan of the head with IV contrast",
    ),
    (
        "RAD-CT-BRAIN",
        "CT Brain Plain",
    ...
    (
        ...
        "CT Urography",
        "50000.00",
        "CT scan of the urinary tract with contrast",
    ),
    (
        "RAD-MRI-BRAIN",
        "MRI Brain Plain",
        "65000.00",
        "MRI scan of the brain without contrast",
    ),
    (
        "RAD-MRI-BRAIN-CONTRAST",
        "MRI Brain with Contrast",
        "85000.00",
        "MRI scan of the brain with IV contrast",
    ),
    (
        "RAD-MRI-SPINE-CERV",
        "MRI Cervical Spine",
    ...
    (
        ...
        "18000.00",
        "Second trimester pregnancy ultrasound with anatomy survey",
    ),
    (
        "RAD-US-OB-THIRD",
        "Obstetric Ultrasound (3rd Trimester)",
        "18000.00",
        "Third trimester pregnancy ultrasound",
    ),
    (
        "RAD-US-TVS",
    ...
    (
        ...
        "12000.00",
        "Ultrasound scan of muscles tendons and joints",
    ),
    (
        "RAD-US-DOPPLER-CAROTID",
    ...
    (
        "RAD-MAMMO-UNILATERAL",
        "Mammography Unilateral",
        "12000.00",
        "Mammogram of one breast",
    ),
    (
        "RAD-MAMMO-DIAGNOSTIC",
        "Diagnostic Mammography",
        "20000.00",
        "Diagnostic mammography with targeted views",
    ),
    (
        "RAD-BARIUM-SWALLOW",
        "Barium Swallow",
        "20000.00",
        "Fluoroscopic study of the esophagus with barium",
    ),
    (
        "RAD-BARIUM-MEAL",
        "Barium Meal",
        "22000.00",
        "Fluoroscopic study of stomach and duodenum with barium",
    ),
    (
        "RAD-BARIUM-ENEMA",
        "Barium Enema",
        "25000.00",
        "Fluoroscopic study of the colon with barium",
    ),
    (
        "RAD-IVU",
        "Intravenous Urography (IVU)",
        "28000.00",
        "X-ray study of the urinary system with IV contrast",
    ),
    (
        "RAD-HSG",
        "Hysterosalpingography (HSG)",
        "25000.00",
        "X-ray study of the uterus and fallopian tubes",
    ),
    (
        "RAD-FLUORO-GI",
        "Fluoroscopy GI Study",
        "20000.00",
        "Fluoroscopic examination of gastrointestinal tract",
    ),
    ...
    (
        ...
        "8000.00",
        "Panoramic X-ray of the jaw and teeth",
    ),
    (
        "RAD-CT-ANGIOGRAPHY",
        "CT Angiography",
        "55000.00",
        "CT scan of blood vessels with contrast",
    ),
    ...
    (
        ...
        "8000.00",
        "X-ray imaging of the paranasal sinuses",
    ),
    (
        "RAD-XRAY-FACIAL",
        "Facial Bones X-Ray",
        "9000.00",
        "X-ray imaging of facial bones",
    ),
    (
        "RAD-CT-SINUS",
    ...
    (
        "RAD-US-GUIDED-BIOPSY",
        "Ultrasound Guided Biopsy",
        "35000.00",
        "Tissue biopsy under ultrasound guidance",
    ),
    (
        "RAD-US-GUIDED-ASPIRATION",
        "Ultrasound Guided Aspiration",
        "28000.00",
        "Fluid aspiration under ultrasound guidance",
    ),
]
