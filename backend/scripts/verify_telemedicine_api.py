...
Usage:
    python manage.py shell < scripts/verify_telemedicine_api.py
    OR
    python scripts/verify_telemedicine_api.py (if run from backend directory)
"""
...
if not all(
    ...
    print(
        "Please set TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, TWILIO_API_KEY, and TWILIO_API_SECRET"
    )
    exit(1)
