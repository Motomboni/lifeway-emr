...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expiry_date",
                    models.DateField(
                        blank=True, help_text="Expiry date (optional)", null=True
                    ),
                ),
                (
                    "location",
        ...
        migrations.AddIndex(
            model_name="druginventory",
            index=models.Index(
                fields=["current_stock"], name="drug_invent_current_229b35_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="druginventory",
            index=models.Index(
                fields=["reorder_level"], name="drug_invent_reorder_4c5d6e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stockmovement",
            index=models.Index(
                fields=["inventory"], name="stock_movem_invento_29e2b8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stockmovement",
        ...
        migrations.AddIndex(
            model_name="stockmovement",
            index=models.Index(
                fields=["prescription"], name="stock_movem_prescri_707d6f_idx"
            ),
        ),
    ]
