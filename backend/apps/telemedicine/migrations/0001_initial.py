...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "twilio_room_sid",
                    models.CharField(
                        help_text="Twilio Room SID", max_length=255, unique=True
                    ),
                ),
                (
                    "twilio_room_name",
                    models.CharField(help_text="Twilio Room Name", max_length=255),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "duration_seconds",
                    models.IntegerField(
                        blank=True, help_text="Session duration in seconds", null=True
                    ),
                ),
                (
                    "recording_enabled",
                ...
                (
                    "notes",
                    models.TextField(blank=True, help_text="Session notes or summary"),
                ),
                (
                    "error_message",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True, help_text="Twilio Participant SID", max_length=255
                    ),
                ),
                (
                    "joined_at",
                    models.DateTimeField(
                        blank=True, help_text="When participant joined", null=True
                    ),
                ),
                (
                    "left_at",
                    models.DateTimeField(
                        blank=True, help_text="When participant left", null=True
                    ),
                ),
                (
                    "connection_quality",
        ...
        migrations.AddIndex(
            model_name="telemedicinesession",
            index=models.Index(
                fields=["twilio_room_sid"], name="telemedicin_twilio__9dda23_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="telemedicinesession",
            index=models.Index(
                fields=["scheduled_start"], name="telemedicin_schedul_caa437_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="telemedicineparticipant",
            index=models.Index(
                fields=["session"], name="telemedicin_session_b9b05c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="telemedicineparticipant",
