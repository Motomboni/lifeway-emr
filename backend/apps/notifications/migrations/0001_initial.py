    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email_body",
                    models.TextField(help_text="Email body content (stored for audit)"),
                ),
                (
                    "sent_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="email_notif_notific_345130_idx",
                    ),
                    models.Index(
                        fields=["status"], name="email_notif_status_242435_idx"
                    ),
                    models.Index(
                        fields=["recipient_email"],
                        name="email_notif_recipie_7e984a_idx",
                    ),
                    models.Index(
                        fields=["created_at"], name="email_notif_created_c1707e_idx"
                    ),
                ],
            },
        ),
