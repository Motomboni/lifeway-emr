    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "planned_start_date",
                    models.DateField(
                        blank=True, help_text="Planned cycle start date", null=True
                    ),
                ),
                (
                    "actual_start_date",
                    models.DateField(
                        blank=True, help_text="Actual stimulation start date", null=True
                    ),
                ),
                (
                    "lmp_date",
                ...
                (
                    "protocol",
                    models.CharField(
                        blank=True, help_text="Stimulation protocol", max_length=100
                    ),
                ),
                (
                    "diagnosis",
                    models.TextField(blank=True, help_text="Infertility diagnosis"),
                ),
                (
                    "consent_signed",
                    models.BooleanField(
                ...
                (
                    "consent_date",
                    models.DateField(
                        blank=True, help_text="Date consent was signed", null=True
                    ),
                ),
                (
                    "partner_consent_signed",
                    models.BooleanField(
                        default=False, help_text="Partner consent form signed"
                    ),
                ),
                (
                    "partner_consent_date",
                    models.DateField(
                        blank=True,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("POOR_RESPONSE", "Poor Ovarian Response"),
                            ("OHSS_RISK", "OHSS Risk"),
                            ("NO_FERTILIZATION", "No Fertilization"),
                            ("NO_VIABLE_EMBRYOS", "No Viable Embryos"),
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="When the cycle was cancelled", null=True
                    ),
                ),
                (
                    "pregnancy_test_date",
                    models.DateField(
                        blank=True, help_text="Date of pregnancy test", null=True
                    ),
                ),
                (
                    "beta_hcg_result",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "day",
                    models.PositiveIntegerField(help_text="Stimulation day number"),
                ),
                ...
                (
                    "medications",
                    models.JSONField(
                        blank=True, default=list, help_text="Medications with doses"
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Clinical notes for the day"
                    ),
                ),
                (
                    "next_appointment",
                    models.DateTimeField(
                        blank=True, help_text="Next monitoring appointment", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "procedure_time",
                    models.TimeField(
                        blank=True, help_text="Time procedure started", null=True
                    ),
                ),
                (
                    "trigger_medication",
                    models.CharField(
                        blank=True, help_text="Trigger medication used", max_length=100
                    ),
                ),
                (
                    "trigger_time",
                    models.DateTimeField(
                        blank=True, help_text="Time of trigger injection", null=True
                    ),
                ),
                (
                    "anesthesia_type",
                ...
                (
                    "anesthesiologist",
                    models.CharField(
                        blank=True, help_text="Anesthesiologist name", max_length=100
                    ),
                ),
                (
                    "right_ovary_oocytes",
                ...
                (
                    "discharge_time",
                    models.TimeField(
                        blank=True, help_text="Time patient discharged", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "collection_date",
                    models.DateField(help_text="Date of sample collection"),
                ),
                (
                    "collection_time",
                    models.TimeField(
                        blank=True, help_text="Time of sample collection", null=True
                    ),
                ),
                (
                    "abstinence_days",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("FRESH", "Fresh Ejaculate"),
                            ("FROZEN", "Frozen Sample"),
                ...
                (
                    "liquefaction_time",
                    models.PositiveIntegerField(
                        blank=True, help_text="Liquefaction time (minutes)", null=True
                    ),
                ),
                (
                    "ph",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("NORMAL", "Normal"), ("INCREASED", "Increased")],
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Sperm concentration (million/mL)",
                        max_digits=10,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Total sperm count (million)",
                        max_digits=10,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Progressive motility (%)",
                        max_digits=5,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="WBC count (million/mL)",
                        max_digits=10,
                        null=True,
                    ),
                ),
                ...
                (
                    "recommendation",
                    models.TextField(blank=True, help_text="Clinical recommendation"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fertilization_date",
                    models.DateField(help_text="Date of fertilization (Day 0)"),
                ),
                (
                    "fertilization_time",
                    models.TimeField(
                        blank=True, help_text="Time of insemination/ICSI", null=True
                    ),
                ),
                (
                    "day1_pn_status",
                ...
                (
                    "day2_cell_count",
                    models.PositiveIntegerField(
                        blank=True, help_text="Cell count at Day 2", null=True
                    ),
                ),
                (
                    "day3_cell_count",
                    models.PositiveIntegerField(
                        blank=True, help_text="Cell count at Day 3", null=True
                    ),
                ),
                (
                    "day3_grade",
                    models.CharField(
                        blank=True, help_text="Day 3 embryo grade", max_length=10
                    ),
                ),
                (
                    "fragmentation",
                    models.PositiveIntegerField(
                        blank=True, help_text="Fragmentation percentage", null=True
                    ),
                ),
                (
                    "blastocyst_day",
                ...
                (
                    "blastocyst_grade",
                    models.CharField(
                        blank=True, help_text="Blastocyst grade", max_length=10
                    ),
                ),
                (
                    "expansion_grade",
                ...
                (
                    "pgt_details",
                    models.TextField(blank=True, help_text="Detailed PGT findings"),
                ),
                (
                    "frozen_date",
                    models.DateField(
                        blank=True, help_text="Date embryo was frozen", null=True
                    ),
                ),
                (
                    "storage_location",
                ...
                (
                    "straw_id",
                    models.CharField(
                        blank=True, help_text="Cryostraw identifier", max_length=50
                    ),
                ),
                (
                    "thaw_date",
                    models.DateField(
                        blank=True, help_text="Date embryo was thawed", null=True
                    ),
                ),
                (
                    "survived_thaw",
                    models.BooleanField(
                        blank=True, help_text="Did embryo survive thawing?", null=True
                    ),
                ),
                (
                    "disposition",
                ...
                (
                    "disposition_date",
                    models.DateField(
                        blank=True, help_text="Date of disposition", null=True
                    ),
                ),
                (
                    "disposition_notes",
                    models.TextField(blank=True, help_text="Notes on disposition"),
                ),
                ("notes", models.TextField(blank=True, help_text="Additional notes")),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "transfer_date",
                    models.DateField(help_text="Date of embryo transfer"),
                ),
                (
                    "transfer_time",
                    models.TimeField(
                        blank=True, help_text="Time of transfer", null=True
                    ),
                ),
                (
                    "transfer_type",
                ...
                (
                    "catheter_type",
                    models.CharField(
                        blank=True, help_text="Transfer catheter used", max_length=100
                    ),
                ),
                (
                    "ultrasound_guided",
                ...
                (
                    ...
                    models.JSONField(
                        blank=True, default=list, help_text="Post-transfer medications"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "medication_name",
                    models.CharField(help_text="Medication name", max_length=100),
                ),
                (
                    "category",
                    models.CharField(
                        choices=[
                            ...
                            ("GONADOTROPIN", "Gonadotropin (FSH/LH)"),
                            ("HCG", "hCG Trigger"),
                ...
                (
                    "dose",
                    models.DecimalField(
                        decimal_places=2, help_text="Dose amount", max_digits=10
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "clinical_pregnancy",
                    models.BooleanField(
                        default=False, help_text="Clinical pregnancy confirmed"
                    ),
                ),
                (
                    "clinical_pregnancy_date",
                    models.DateField(
                        blank=True,
                ...
                (
                    "fetal_heartbeat_date",
                    models.DateField(
                        blank=True, help_text="Date fetal heartbeat detected", null=True
                    ),
                ),
                (
                    "gestational_sacs",
                ...
                (
                    "miscarriage",
                    models.BooleanField(
                        default=False, help_text="Miscarriage occurred"
                    ),
                ),
                (
                    "miscarriage_date",
                    models.DateField(
                        blank=True, help_text="Date of miscarriage", null=True
                    ),
                ),
                (
                    "miscarriage_gestational_age",
                    models.PositiveIntegerField(
                        blank=True,
                ...
                (
                    "ectopic",
                    models.BooleanField(default=False, help_text="Ectopic pregnancy"),
                ),
                (
                    "delivery_date",
                    models.DateField(
                        blank=True, help_text="Date of delivery", null=True
                    ),
                ),
                (
                ...
                (
                    "birth_weights",
                    models.JSONField(
                        blank=True, default=list, help_text="Birth weights in grams"
                    ),
                ),
                (
                    "maternal_complications",
                    models.TextField(blank=True, help_text="Maternal complications"),
                ),
                (
                    "neonatal_complications",
                    models.TextField(blank=True, help_text="Neonatal complications"),
                ),
                ("notes", models.TextField(blank=True, help_text="Additional notes")),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("TREATMENT", "IVF Treatment Consent"),
                            ("EGG_RETRIEVAL", "Egg Retrieval Consent"),
                            ("SPERM_COLLECTION", "Sperm Collection Consent"),
                            ("EMBRYO_TRANSFER", "Embryo Transfer Consent"),
                            ("EMBRYO_FREEZING", "Embryo Cryopreservation Consent"),
                            ("EMBRYO_DISPOSITION", "Embryo Disposition Consent"),
                            ("EGG_FREEZING", "Egg Freezing Consent"),
                            ("SPERM_FREEZING", "Sperm Freezing Consent"),
                            ("PGT", "Genetic Testing Consent"),
                            ("DONOR_EGG", "Donor Egg Consent"),
                            ("DONOR_SPERM", "Donor Sperm Consent"),
                            ("SURROGACY", "Surrogacy Agreement Consent"),
                        ],
                ...
                (
                    "signed",
                    models.BooleanField(default=False, help_text="Has been signed"),
                ),
                (
                    "signed_date",
                    models.DateField(blank=True, help_text="Date signed", null=True),
                ),
                (
                    "signed_time",
                    models.TimeField(blank=True, help_text="Time signed", null=True),
                ),
                (
                    "witness_name",
                    models.CharField(
                        blank=True, help_text="Witness name", max_length=100
                    ),
                ),
                (
                    "witness_signature",
                    models.BooleanField(default=False, help_text="Witness signed"),
                ),
                (
                    "document_path",
                    models.FileField(
                ...
                (
                    "revoked",
                    models.BooleanField(
                        default=False, help_text="Consent has been revoked"
                    ),
                ),
                (
                    "revoked_date",
                    models.DateField(
                        blank=True, help_text="Date consent was revoked", null=True
                    ),
                ),
                (
                    "revocation_reason",
        ...
        migrations.AddIndex(
            model_name="ivfcycle",
            index=models.Index(
                fields=["patient"], name="ivf_cycles_patient_01ada8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ivfcycle",
            index=models.Index(
                fields=["partner"], name="ivf_cycles_partner_9461b3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ivfcycle",
        ...
        migrations.AddIndex(
            model_name="ivfcycle",
            index=models.Index(
                fields=["cycle_type"], name="ivf_cycles_cycle_t_62d2af_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ivfcycle",
            index=models.Index(
                fields=["created_at"], name="ivf_cycles_created_13f3f9_idx"
            ),
        ),
