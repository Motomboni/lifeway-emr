...
class IVFCycleAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Patient Information", {"fields": ("patient", "partner", "cycle_number")}),
        (
            "Cycle Details",
            {"fields": ("cycle_type", "status", "protocol", "diagnosis")},
        ),
        ("Dates", {"fields": ("planned_start_date", "actual_start_date", "lmp_date")}),
        (
        ...
        (
            "Outcome",
            {"fields": ("pregnancy_test_date", "beta_hcg_result", "pregnancy_outcome")},
        ),
        (
            "Cancellation",
            {
...
class SpermAnalysisAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Concentration & Count", {"fields": ("concentration", "total_sperm_count")}),
        (
            "Motility",
            {
                "fields": (
        ...
        ("Assessment", {"fields": ("assessment", "recommendation", "notes")}),
        ("Audit", {"fields": ("analyzed_by", "created_at"), "classes": ["collapse"]}),
    )
...
class EmbryoAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identification", {"fields": ("cycle", "embryo_number", "lab_id", "status")}),
        (
            "Fertilization",
            {
                "fields": (
        ...
        ("Genetic Testing", {"fields": ("pgt_performed", "pgt_result", "pgt_details")}),
        (
            "Cryopreservation",
            {
                "fields": (
