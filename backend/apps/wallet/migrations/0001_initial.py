...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Channel name", max_length=50, unique=True
                    ),
                ),
                (
                    "channel_type",
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether channel is active"
                    ),
                ),
                (
                    "config",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="Whether wallet is active"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.AddIndex(
            model_name="wallettransaction",
            index=models.Index(
                fields=["gateway_transaction_id"], name="wallet_tran_gateway_71c1f4_idx"
            ),
        ),
    ]
