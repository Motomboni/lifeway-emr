        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "consultation",
                    models.ForeignKey(
                        help_text="Consultation this procedure belongs to. Procedures require consultation context.",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["visit"], name="procedure_t_visit_i_ee7924_idx"
                    ),
                    models.Index(
                        fields=["consultation"], name="procedure_t_consult_2bcbeb_idx"
                    ),
                    models.Index(
                        fields=["service_catalog"],
                        name="procedure_t_service_ec424a_idx",
                    ),
                    models.Index(
                        fields=["status"], name="procedure_t_status_1444c6_idx"
                    ),
                    models.Index(
                        fields=["ordered_by"], name="procedure_t_ordered_7d9b3b_idx"
                    ),
                    models.Index(
                        fields=["executed_by"], name="procedure_t_execute_1996db_idx"
                    ),
                ],
            },
        ),
