        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "related_resource_id",
                    models.IntegerField(
                        blank=True, help_text="ID of related resource", null=True
                    ),
                ),
                (
                    "acknowledged_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="clinical_al_visit_i_3919c5_idx",
                    ),
                    models.Index(
                        fields=["alert_type", "is_resolved"],
                        name="clinical_al_alert_t_003294_idx",
                    ),
                    models.Index(
                        fields=["severity", "is_resolved"],
                        name="clinical_al_severit_6d0ad5_idx",
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="clinical_te_categor_173d6b_idx",
                    ),
                    models.Index(
                        fields=["created_by"], name="clinical_te_created_8f0215_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Additional notes about vital signs"
                    ),
                ),
                (
                    "recorded_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="vital_signs_visit_i_d107e4_idx",
                    ),
                    models.Index(
                        fields=["recorded_by"], name="vital_signs_recorde_db16b7_idx"
                    ),
                ],
            },
        ),
