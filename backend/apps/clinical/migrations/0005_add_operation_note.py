        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "operation_name",
                    models.CharField(
                        help_text="Name of the operation/procedure", max_length=255
                    ),
                ),
                (
                ...
                (
                    "indication",
                    models.TextField(help_text="Clinical indication for the operation"),
                ),
                (
                    "anesthesia_type",
                    models.CharField(
                ...
                (
                    "findings",
                    models.TextField(blank=True, help_text="Intraoperative findings"),
                ),
                (
                    "technique",
                    models.TextField(blank=True, help_text="Surgical technique used"),
                ),
                (
                    "complications",
                    models.TextField(
                ...
                (
                    "postoperative_plan",
                    models.TextField(blank=True, help_text="Postoperative care plan"),
                ),
                (
                ...
                (
                    "operation_date",
                    models.DateTimeField(help_text="Date and time of the operation"),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["visit", "-operation_date"],
                        name="operation_n_visit_i_b16cd0_idx",
                    ),
                    models.Index(
                        fields=["consultation"], name="operation_n_consult_c08160_idx"
                    ),
                    models.Index(
                        fields=["surgeon"], name="operation_n_surgeon_e79ae2_idx"
                    ),
                    models.Index(
                        fields=["operation_type"], name="operation_n_operati_a32a79_idx"
                    ),
                ],
            },
        ),
