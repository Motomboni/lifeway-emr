...
class VitalSignsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Visit Information", {"fields": ("visit", "recorded_by", "recorded_at")}),
        (
            "Vital Signs",
            {
                "fields": (
...
class ClinicalTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Metadata", {"fields": ("usage_count", "created_at", "updated_at")}),
    )
...
class ProcedureTaskAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Ordering", {"fields": ("ordered_by", "status")}),
        ("Execution", {"fields": ("executed_by", "execution_date", "execution_notes")}),
...
class OperationNoteAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ["created_at", "updated_at"]
    fieldsets = (
        ("Visit & Consultation", {"fields": ("visit", "consultation")}),
        (
            "Surgeons & Anesthesia",
        ...
        ("Anesthesia", {"fields": ("anesthesia_type", "anesthesia_notes")}),
        (
            "Procedure",
            {
                "fields": (
        ...
        ("Additional Details", {"fields": ("estimated_blood_loss", "specimens_sent")}),
        (
            "Postoperative",
