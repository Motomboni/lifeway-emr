...
from .bill_item_views import AddBillItemView, GetServicePriceView, ListServicesView
...
urlpatterns = [
    ...
    path(
        "visit/<int:visit_id>/summary/",
        VisitBillingSummaryView.as_view(),
        name="visit-billing-summary",
    ),
]
