...
from .bill_models import Bill, BillItem, BillPayment, InsurancePolicy, InsuranceProvider
...
from .models import Payment, PaymentIntent, VisitCharge
...
class LeakRecordAdmin(admin.ModelAdmin):
    ...
    def mark_as_resolved(self, request, queryset):
        ...
        self.message_user(request, f"{count} leak(s) marked as resolved.")
...
class NHIATariffAdmin(admin.ModelAdmin):
    ...
    search_fields = ("nhia_code", "name", "keywords")
    readonly_fields = ("created_at", "updated_at")
