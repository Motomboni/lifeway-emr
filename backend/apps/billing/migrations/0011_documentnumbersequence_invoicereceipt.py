    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current_number",
                    models.IntegerField(default=0, help_text="Current sequence number"),
                ),
                (
                    "prefix",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "emailed_at",
                    models.DateTimeField(
                        blank=True, help_text="When document was emailed", null=True
                    ),
                ),
                (
                    "sms_sent_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="invoice_rec_documen_4040b6_idx",
                    ),
                    models.Index(
                        fields=["visit", "document_type"],
                        name="invoice_rec_visit_i_985d0a_idx",
                    ),
                    models.Index(
                        fields=["generated_at"], name="invoice_rec_generat_d6a2fa_idx"
                    ),
                ],
            },
        ),
