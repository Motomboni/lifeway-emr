    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notes",
                    models.TextField(blank=True, help_text="Payment notes or remarks"),
                ),
                (
                    "created_at",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "policy_number",
                    models.CharField(
                        help_text="Insurance policy number", max_length=255
                    ),
                ),
                (
                    "coverage_type",
                ...
                (
                    "valid_from",
                    models.DateField(help_text="Policy validity start date"),
                ),
                (
                    "valid_to",
                    models.DateField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "contact_person",
                    models.CharField(
                        blank=True, help_text="Contact person name", max_length=255
                    ),
                ),
                (
                    "contact_phone",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "service_name",
                    models.CharField(
                        help_text="Name of the service/item", max_length=255
                    ),
                ),
                (
                    "amount",
                    models.DecimalField(
                        decimal_places=2, help_text="Item amount", max_digits=10
                    ),
                ),
                (
                    "status",
            ...
            options={
                ...
                "ordering": ["created_at"],
                "indexes": [
                    models.Index(fields=["bill"], name="bill_items_bill_id_2050b1_idx"),
                    models.Index(
                        fields=["department"], name="bill_items_departm_3eeca8_idx"
                    ),
                    models.Index(
                        fields=["status"], name="bill_items_status_d9c072_idx"
                    ),
                    models.Index(
                        fields=["created_at"], name="bill_items_created_0aed48_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="bill",
            index=models.Index(
                fields=["is_insurance_backed"], name="bills_is_insu_a70a02_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="bill",
        ...
        migrations.AddIndex(
            model_name="insurancepolicy",
            index=models.Index(
                fields=["patient"], name="insurance_p_patient_d2a95b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="insurancepolicy",
            index=models.Index(
                fields=["provider"], name="insurance_p_provide_b9f121_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="insurancepolicy",
        ...
        migrations.AddIndex(
            model_name="insurancepolicy",
            index=models.Index(
                fields=["is_active"], name="insurance_p_is_acti_de1bda_idx"
            ),
        ),
    ]
