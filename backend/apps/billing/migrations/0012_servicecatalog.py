    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["service_code"], name="service_cat_service_1d5b2a_idx"
                    ),
                    models.Index(
                        fields=["department"], name="service_cat_departm_e55195_idx"
                    ),
                    models.Index(
                        fields=["department", "is_active"],
                        name="service_cat_departm_046e53_idx",
                    ),
                    models.Index(
                        fields=["workflow_type"], name="service_cat_workflo_dcbc78_idx"
                    ),
                    models.Index(
                        fields=["is_active"], name="service_cat_is_acti_40b383_idx"
                    ),
                ],
            },
        ),
