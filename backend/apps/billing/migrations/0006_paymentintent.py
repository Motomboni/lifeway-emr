    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["visit"], name="payment_int_visit_i_439695_idx"
                    ),
                    models.Index(
                        fields=["paystack_reference"],
                        name="payment_int_paystac_bd7c0d_idx",
                    ),
                    models.Index(
                        fields=["status"], name="payment_int_status_0f02ee_idx"
                    ),
                    models.Index(
                        fields=["created_at"], name="payment_int_created_25a39a_idx"
                    ),
                ],
            },
        ),
