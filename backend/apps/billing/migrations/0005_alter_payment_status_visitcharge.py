        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount",
                    models.DecimalField(
                        decimal_places=2, help_text="Charge amount", max_digits=10
                    ),
                ),
                (
                    "created_by_system",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["visit"], name="visit_charg_visit_i_6f4d9f_idx"
                    ),
                    models.Index(
                        fields=["category"], name="visit_charg_categor_56813c_idx"
                    ),
                    models.Index(
                        fields=["created_at"], name="visit_charg_created_3200a2_idx"
                    ),
                ],
            },
        ),
