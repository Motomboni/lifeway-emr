...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "policy_number",
                    models.CharField(
                        help_text="Patient's insurance policy number", max_length=100
                    ),
                ),
                (
                    "coverage_type",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="Date of insurance approval", null=True
                    ),
                ),
                (
                    "rejection_reason",
        ...
        migrations.AddIndex(
            model_name="hmoprovider",
            index=models.Index(
                fields=["is_active"], name="hmo_provide_is_acti_b32f30_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="visitinsurance",
            index=models.Index(
                fields=["provider"], name="visit_insur_provide_bb5b8f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="visitinsurance",
            index=models.Index(
                fields=["approval_status"], name="visit_insur_approva_91ae3c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="visitinsurance",
            index=models.Index(
                fields=["coverage_type"], name="visit_insur_coverag_2523d6_idx"
            ),
        ),
    ]
