            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="leak_record_entity__5aa6c6_idx",
                    ),
                    models.Index(
                        fields=["visit"], name="leak_record_visit_i_25ecc6_idx"
                    ),
                    models.Index(
                        fields=["detected_at"], name="leak_record_detecte_f8d1f5_idx"
                    ),
                    models.Index(
                        fields=["resolved_at"], name="leak_record_resolve_6c644d_idx"
                    ),
                    models.Index(
                        fields=["service_code"], name="leak_record_service_38b91f_idx"
                    ),
                    models.Index(
                        fields=["entity_type", "resolved_at"],
                        name="leak_record_entity__415b01_idx",
                    ),
                ],
                "constraints": [
