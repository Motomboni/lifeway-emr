...
class Migration(migrations.Migration):
    dependencies = [
        ...
        (
            "consultations",
            "0004_consultation_status_alter_consultation_created_by_and_more",
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now=True,
                        help_text="When this billing line item was last updated",
                    ),
                ),
                (
                    "paid_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["service_catalog"],
                        name="billing_lin_service_dce314_idx",
                    ),
                    models.Index(
                        fields=["visit"], name="billing_lin_visit_i_61db93_idx"
                    ),
                    models.Index(
                        fields=["consultation"], name="billing_lin_consult_cfff9a_idx"
                    ),
                    models.Index(
                        fields=["source_service_code"],
                        name="billing_lin_source__750a2a_idx",
                    ),
                    models.Index(
                        fields=["bill_status"], name="billing_lin_bill_st_0a4966_idx"
                    ),
                    models.Index(
                        fields=["created_at"], name="billing_lin_created_7a5c04_idx"
                    ),
                    models.Index(
                        fields=["visit", "bill_status"],
                        name="billing_lin_visit_i_05f0c9_idx",
                    ),
                    models.Index(
                        fields=["service_catalog", "visit"],
                        name="billing_lin_service_c7023f_idx",
                    ),
                ],
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(
                            ("service_catalog__isnull", False), ("visit__isnull", False)
                        ),
