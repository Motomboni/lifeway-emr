...
class BasePriceList(models.Model):
    ...
    service_name = models.CharField(max_length=255, help_text="Name of the service")

    amount = models.DecimalField(
        max_digits=10, decimal_places=2, help_text="Service price"
    )
    ...
    created_at = models.DateTimeField(
        auto_now_add=True, help_text="When service was added to price list"
    )

    updated_at = models.DateTimeField(
        auto_now=True, help_text="When service was last updated"
    )
