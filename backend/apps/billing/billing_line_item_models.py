...
class BillingLineItem(models.Model):
    ...
    created_at = models.DateTimeField(
        auto_now_add=True, help_text="When this billing line item was created"
    )
    ...
    paid_at = models.DateTimeField(
        null=True, blank=True, help_text="When this billing line item was fully paid"
    )
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.CheckConstraint(
                condition=Q(amount__gt=0), name="billing_line_item_amount_positive"
            ),
    ...
    def apply_payment(self, payment_amount: Decimal, payment_method: str) -> None:
        ...
        if self.bill_status == "PAID":
            raise ValidationError(
                "Cannot apply payment to a fully paid billing line item."
            )
    ...
    def delete(self, *args, **kwargs):
        ...
        if not is_superuser_purge_active() and self.is_immutable():
            raise ValidationError(
