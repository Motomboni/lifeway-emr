...
Run this from Django shell: python manage.py shell < apps/billing/check_logo.py
Or: python manage.py shell, then import and run check_logo_path()
"""
...
def check_logo_path():
    ...
    relative_path = (
        current_file_dir.parent.parent.parent / "frontend" / "public" / "logo.png"
    )
