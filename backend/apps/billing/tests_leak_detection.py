...
class LeakDetectionTestCase(TestCase):
    ...
    def setUp(self):
        ...
        assert self.visit.payment_status == "PAID", (
            f"Visit payment_status should be PAID, got {self.visit.payment_status}"
        )
...
class LeakResolutionTest(LeakDetectionTestCase):
    ...
    def test_leak_resolution(self):
        ...
        # Resolve leak
        leak.resolve(user=self.doctor, notes="Bill was created and paid")
