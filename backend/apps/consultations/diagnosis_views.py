...
from core.permissions import IsDoctor, IsPaymentCleared, IsVisitAccessible, IsVisitOpen
...
class DiagnosisCodeViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return DiagnosisCode.objects.filter(consultation=consultation).select_related(
            "created_by"
        )
    ...
    def perform_create(self, serializer):
        ...
        if serializer.validated_data.get("is_primary"):
            DiagnosisCode.objects.filter(
                consultation=consultation, is_primary=True
        ...
        try:
            log_consultation_action(
                ...
                extra_data={
                    ...
                    "is_primary": diagnosis_code.is_primary,
                },
            )
        except Exception:
    ...
    def perform_update(self, serializer):
        ...
        if serializer.validated_data.get("is_primary", False):
            DiagnosisCode.objects.filter(
                consultation=diagnosis_code.consultation, is_primary=True
        ...
        try:
            log_consultation_action(
                ...
                extra_data={
                    ...
                    "is_primary": updated_code.is_primary,
                },
            )
        except Exception:
            pass  # Don't fail request if audit logging fails
