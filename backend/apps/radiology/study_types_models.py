...
class RadiologyStudyType(models.Model):
    ...
    study_name = models.CharField(
        max_length=200, help_text="Full name of the radiology study"
    )
    ...
    description = models.TextField(
        blank=True, help_text="Description of what the study examines"
    )

    protocol = models.TextField(
        blank=True, help_text="Protocol or procedure details for performing the study"
    )
    ...
    contrast_required = models.BooleanField(
        default=False, help_text="Whether contrast agent is required"
    )
    ...
    estimated_duration_minutes = models.IntegerField(
        null=True, blank=True, help_text="Estimated duration of the study in minutes"
    )
    ...
    requires_sedation = models.BooleanField(
        default=False, help_text="Whether sedation is required for this study"
    )
    ...
    created_at = models.DateTimeField(
        auto_now_add=True, help_text="When the study type was added to the catalog"
    )

    updated_at = models.DateTimeField(
        auto_now=True, help_text="When the study type was last updated"
    )
