...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    f"[OK] Radiology Tech: {radiology_tech.get_full_name()}"
                )
            )
            ...
            self.stdout.write(
                self.style.SUCCESS(f"[OK] Patient: {patient.get_full_name()}")
            )
            ...
            self.stdout.write(
                self.style.SUCCESS(f"[OK] Consultation: {consultation.id}")
            )
            ...
            self.stdout.write(
                self.style.SUCCESS(f"[OK] Radiology Order: {radiology_order.id}")
            )

        except Exception as e:
            self.stdout.write(
                self.style.ERROR(f"[ERROR] Error creating test data: {e}")
            )
            import traceback
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(f"[OK] Study created: {study.study_uid}")
            )
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(f"[OK] Series created: {series.series_uid}")
            )
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(f"[OK] File key generated: {file_key}")
            )
        except Exception as e:
            self.stdout.write(
                self.style.ERROR(f"[ERROR] Error generating file key: {e}")
            )
            import traceback
        ...
        try:
            ...
            test_file_content = (
                b"Test DICOM file content for PACS-lite testing - " + b"X" * 1000
            )
            ...
            self.stdout.write(
                self.style.SUCCESS(f"[OK] Metadata uploaded: {metadata.image_uuid}")
            )
            ...
            self.stdout.write(
                self.style.ERROR(f"[ERROR] Error uploading metadata: {e}")
            )
            import traceback
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(f"[OK] Binary uploaded: {image.image_uid}")
            )
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(f"[OK] ACK received: {ack_metadata.status}")
            )
            self.stdout.write(f"  - ACK received at: {ack_metadata.ack_received_at}")
        except Exception as e:
            self.stdout.write(
                self.style.ERROR(f"[ERROR] Error acknowledging upload: {e}")
            )
            import traceback
        ...
        try:
            viewer_url = PACSLiteService.generate_viewer_url(
                study_uid=study.study_uid, user=radiology_tech, expires_in=3600
            )
            self.stdout.write(
                self.style.SUCCESS(f"[OK] Viewer URL generated: {viewer_url}")
            )
        except Exception as e:
            self.stdout.write(
                self.style.ERROR(f"[ERROR] Error generating viewer URL: {e}")
            )
            import traceback
        ...
        try:
            image_url = PACSLiteService.generate_image_url(
                image=image, user=radiology_tech, expires_in=3600
            )
            self.stdout.write(
                self.style.SUCCESS(f"[OK] Image URL generated: {image_url}")
            )
        except Exception as e:
            self.stdout.write(
                self.style.ERROR(f"[ERROR] Error generating image URL: {e}")
            )
            import traceback
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    f"[OK] Retrieved {len(study_images)} images for study"
                )
            )
            ...
            self.stdout.write(
                self.style.ERROR(f"[ERROR] Error retrieving study images: {e}")
            )
            import traceback
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    f"[OK] Retrieved {len(series_images)} images for series"
                )
            )
            ...
            self.stdout.write(
                self.style.ERROR(f"[ERROR] Error retrieving series images: {e}")
            )
            import traceback
        ...
        self.stdout.write("\n" + "=" * 80)
        self.stdout.write(
            self.style.SUCCESS("[OK] All PACS-lite Integration Tests Passed!")
        )
        self.stdout.write("=" * 80)
        self.stdout.write("\nTest Summary:")
