    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "series_number",
                    models.IntegerField(
                        blank=True, help_text="Series number (from DICOM)", null=True
                    ),
                ),
                (
                    "series_description",
                    models.CharField(
                        blank=True, help_text="Series description", max_length=255
                    ),
                ),
                (
                    "modality",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "study_description",
                    models.CharField(
                        blank=True, help_text="Study description", max_length=255
                    ),
                ),
                (
                    "modality",
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(
                blank=True, help_text="Instance number (from DICOM)", null=True
            ),
        ),
        migrations.AddField(
            model_name="radiologyimage",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="images",
                to="radiology.radiologyseries",
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyimage",
            index=models.Index(
                fields=["series"], name="radiology_i_series__06bf01_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyimage",
            index=models.Index(
                fields=["image_uid"], name="radiology_i_image_u_b5d80a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyimage",
            index=models.Index(
                fields=["file_key"], name="radiology_i_file_ke_dc4fca_idx"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="radiologystudy",
            index=models.Index(
                fields=["study_uid"], name="radiology_s_study_u_0e8792_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologystudy",
            index=models.Index(
                fields=["radiology_order"], name="radiology_s_radiolo_c68803_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologystudy",
            index=models.Index(
                fields=["study_date"], name="radiology_s_study_d_6bbb98_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyseries",
            index=models.Index(
                fields=["series_uid"], name="radiology_s_series__e11514_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyseries",
        ...
        migrations.AddIndex(
            model_name="radiologyseries",
            index=models.Index(
                fields=["series_number"], name="radiology_s_series__38d1c5_idx"
            ),
        ),
