...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="last_retry_at",
            field=models.DateTimeField(
                blank=True, help_text="Timestamp of last retry attempt", null=True
            ),
        ),
        migrations.AddField(
            model_name="imageuploadsession",
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(
                blank=True, help_text="Timestamp when metadata was uploaded", null=True
            ),
        ),
        migrations.AddField(
            model_name="imageuploadsession",
        ...
        migrations.AddIndex(
            model_name="imageuploadsession",
            index=models.Index(
                fields=["session_id"], name="image_uploa_session_971ae6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="imageuploadsession",
            index=models.Index(
                fields=["local_file_uuid"], name="image_uploa_local_f_54801b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="imageuploadsession",
        ...
        migrations.AddIndex(
            model_name="imageuploadsession",
            index=models.Index(
                fields=["created_at"], name="image_uploa_created_55ee09_idx"
            ),
        ),
