...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="radiologyorder",
            index=models.Index(
                fields=["ordered_by"], name="radiology_o_ordered_a51691_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyorder",
            index=models.Index(
                fields=["imaging_type"], name="radiology_o_imaging_f9f5f1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyrequest",
        ...
        migrations.AddIndex(
            model_name="radiologyrequest",
            index=models.Index(
                fields=["consultation"], name="radiology_r_consult_354a69_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyrequest",
        ...
        migrations.AddIndex(
            model_name="radiologyrequest",
            index=models.Index(
                fields=["ordered_by"], name="radiology_r_ordered_829f6a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyresult",
            index=models.Index(
                fields=["radiology_order"], name="radiology_r_radiolo_5e5285_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyresult",
            index=models.Index(
                fields=["reported_by"], name="radiology_r_reporte_8fe1db_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyresult",
            index=models.Index(
                fields=["reported_at"], name="radiology_r_reporte_967960_idx"
            ),
        ),
    ]
