...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "filename",
                    models.CharField(
                        help_text="Original filename of the image", max_length=255
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "METADATA_UPLOADED",
                                "Metadata Uploaded - Waiting for binary upload",
                            ),
                            (
                                "BINARY_UPLOADED",
                                "Binary Uploaded - Waiting for server ACK",
                            ),
                            (
                                "ACK_RECEIVED",
                ...
                (
                    "last_retry_at",
                    models.DateTimeField(
                        blank=True, help_text="When upload was last retried", null=True
                    ),
                ),
                (
                    "radiology_order",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image_file",
                    models.FileField(
                        help_text="Image file (DICOM or JPEG) - stored outside DB",
                        upload_to="radiology/images/%Y/%m/%d/",
                    ),
                ),
                (
                    "checksum",
                ...
                (
                    "validated_at",
                    models.DateTimeField(
                        blank=True, help_text="When checksum was validated", null=True
                    ),
                ),
                (
                    "offline_metadata",
                    models.OneToOneField(
                        help_text="Link to offline metadata that was uploaded",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="server_image",
                        to="radiology.offlineimagemetadata",
                    ),
                ),
                (
                    "radiology_order",
        ...
        migrations.AddIndex(
            model_name="offlineimagemetadata",
            index=models.Index(
                fields=["radiology_order"], name="radiology_o_radiolo_d8f801_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="offlineimagemetadata",
            index=models.Index(
                fields=["image_uuid"], name="radiology_o_image_u_f8a7db_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="offlineimagemetadata",
            index=models.Index(
                fields=["checksum"], name="radiology_o_checksu_1a2f42_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="offlineimagemetadata",
            index=models.Index(
                fields=["created_at"], name="radiology_o_created_187d48_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyimage",
            index=models.Index(
                fields=["radiology_order"], name="radiology_i_radiolo_acadbf_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyimage",
            index=models.Index(
                fields=["checksum"], name="radiology_i_checksu_b36b5e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="radiologyimage",
            index=models.Index(
                fields=["uploaded_at"], name="radiology_i_uploade_5168e7_idx"
            ),
        ),
