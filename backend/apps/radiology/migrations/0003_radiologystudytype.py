        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "study_name",
                    models.CharField(
                        help_text="Full name of the radiology study", max_length=200
                    ),
                ),
                (
                    "category",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["study_code"], name="radiology_s_study_c_bda2a2_idx"
                    ),
                    models.Index(
                        fields=["category"], name="radiology_s_categor_6705a9_idx"
                    ),
                    models.Index(
                        fields=["is_active"], name="radiology_s_is_acti_c77c3d_idx"
                    ),
                    models.Index(
                        fields=["study_name"], name="radiology_s_study_n_5ebec4_idx"
                    ),
                ],
            },
        ),
