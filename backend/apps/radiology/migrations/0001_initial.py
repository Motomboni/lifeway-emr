        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "body_part",
                    models.CharField(
                        help_text="Body part to be imaged", max_length=100
                    ),
                ),
                (
                    "clinical_indication",
                    models.TextField(help_text="Reason for imaging request"),
                ),
                (
                    "priority",
                    models.CharField(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="PENDING",
                        help_text="Status of the radiology request",
                        max_length=20,
                    ),
                ),
                (
                ...
                (
                    "report_date",
                    models.DateTimeField(
                        blank=True, help_text="When the report was posted", null=True
                    ),
                ),
                (
                    "image_count",
                    models.IntegerField(
                        blank=True, help_text="Number of images in the study", null=True
                    ),
                ),
                (
                    "image_metadata",
