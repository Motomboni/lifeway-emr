...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "started_at",
                    models.DateTimeField(
                        blank=True, help_text="When the upload started", null=True
                    ),
                ),
                (
                    "completed_at",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="radiology.imageuploadsession",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["session_uuid"], name="image_uploa_session_8a6597_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="imageuploadsession",
            index=models.Index(
                fields=["radiology_order", "status"],
                name="image_uploa_radiolo_550a3f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="imageuploadsession",
            index=models.Index(
                fields=["status", "created_at"], name="image_uploa_status_b4121f_idx"
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="image_uploa_session_b84d16_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="imageuploaditem",
            index=models.Index(
                fields=["upload_status"], name="image_uploa_upload__207bfa_idx"
            ),
        ),
