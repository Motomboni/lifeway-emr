    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["visit", "-collection_time"],
                        name="lab_sample__visit_i_7d98c0_idx",
                    ),
                    models.Index(
                        fields=["lab_order"], name="lab_sample__lab_ord_96856e_idx"
                    ),
                    models.Index(
                        fields=["collected_by"], name="lab_sample__collect_84cfd5_idx"
                    ),
                    models.Index(
                        fields=["status"], name="lab_sample__status_68e6fe_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["visit", "-administration_time"],
                        name="medication__visit_i_05594f_idx",
                    ),
                    models.Index(
                        fields=["prescription"], name="medication__prescri_57d213_idx"
                    ),
                    models.Index(
                        fields=["administered_by"],
                        name="medication__adminis_b26548_idx",
                    ),
                    models.Index(
                        fields=["status"], name="medication__status_0275c2_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["visit", "-recorded_at"],
                        name="nursing_not_visit_i_276230_idx",
                    ),
                    models.Index(
                        fields=["recorded_by"], name="nursing_not_recorde_fc46d6_idx"
                    ),
                    models.Index(
                        fields=["note_type"], name="nursing_not_note_ty_52d101_idx"
                    ),
                ],
            },
        ),
