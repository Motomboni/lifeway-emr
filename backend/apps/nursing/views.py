...
class NursingNoteViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return (
            NursingNote.objects.filter(visit_id=visit_id)
    ...
    def perform_create(self, serializer):
        ...
        note = serializer.save(visit=visit, recorded_by=self.request.user)
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        raise PermissionDenied(
            "Nursing notes cannot be deleted to maintain audit trail. Records are permanent."
        )
...
class MedicationAdministrationViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return (
            MedicationAdministration.objects.filter(visit_id=visit_id)
    ...
    def merge_with_patient_history(self, administration, visit):
        ...
        timestamp = (
            administration.administration_time
            if administration.administration_time
            else timezone.now()
        )
        timestamp_str = timestamp.strftime("%Y-%m-%d %H:%M")
    ...
    def perform_create(self, serializer):
        ...
        administration = serializer.save(visit=visit, administered_by=self.request.user)
    ...
    def destroy(self, request, *args, **kwargs):
        """Prevent deletion - maintain audit trail."""
        raise PermissionDenied(
            "Medication administration records cannot be deleted to maintain audit trail. Records are permanent."
        )
...
class LabSampleCollectionViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return (
            LabSampleCollection.objects.filter(visit_id=visit_id)
    ...
    def merge_with_patient_history(self, collection, visit):
        ...
        timestamp = (
            collection.collection_time if collection.collection_time else timezone.now()
        )
        timestamp_str = timestamp.strftime("%Y-%m-%d %H:%M")
    ...
    def perform_create(self, serializer):
        ...
        collection = serializer.save(visit=visit, collected_by=self.request.user)
    ...
    def destroy(self, request, *args, **kwargs):
        """Prevent deletion - maintain audit trail."""
        raise PermissionDenied(
            "Lab sample collection records cannot be deleted to maintain audit trail. Records are permanent."
        )
