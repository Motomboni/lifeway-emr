...
from core.permissions import IsVisitAccessible, IsVisitOpen
...
from .serializers import MedicalDocumentCreateSerializer, MedicalDocumentSerializer
...
class MedicalDocumentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        queryset = MedicalDocument.objects.filter(
            visit_id=visit_id, is_deleted=False
    ...
    def perform_create(self, serializer):
        ...
        document = serializer.save(visit=visit, uploaded_by=self.request.user)
    ...
    def destroy(self, request, *args, **kwargs):
        """Soft delete for staff; superusers may permanently delete."""
        ...
        if user_role not in ["DOCTOR", "RECEPTIONIST"]:
            raise PermissionDenied(
                "Only doctors and receptionists can delete documents."
            )
