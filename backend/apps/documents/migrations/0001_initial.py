    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(help_text="Document title/name", max_length=200),
                ),
                (
                    "description",
                    models.TextField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="medical_doc_visit_i_c2e1bb_idx",
                    ),
                    models.Index(
                        fields=["document_type", "is_deleted"],
                        name="medical_doc_documen_e72352_idx",
                    ),
                    models.Index(
                        fields=["uploaded_by"], name="medical_doc_uploade_55ae1a_idx"
                    ),
                ],
            },
        ),
