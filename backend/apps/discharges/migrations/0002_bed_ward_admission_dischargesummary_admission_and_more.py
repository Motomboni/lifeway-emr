    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Additional notes about this bed"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(blank=True, help_text="Description of the ward"),
                ),
                (
                    "capacity",
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "chief_complaint",
                    models.TextField(help_text="Chief complaint at admission"),
                ),
                (
                    "admission_notes",
                    models.TextField(
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="discharges.dischargesummary",
                    ),
                ),
                (
                    "transferred_from",
        ...
        migrations.AddIndex(
            model_name="bed",
            index=models.Index(
                fields=["ward", "is_available"], name="beds_ward_id_d76208_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="admission",
            index=models.Index(
                fields=["ward", "admission_status"],
                name="admissions_ward_id_ea37d9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="admission",
            index=models.Index(
                fields=["bed", "admission_status"], name="admissions_bed_id_3b8101_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="admission",
            index=models.Index(
                fields=["admission_status"], name="admissions_admissi_7cade7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="admission",
            index=models.Index(
                fields=["admission_date"], name="admissions_admissi_aeb84d_idx"
            ),
        ),
    ]
