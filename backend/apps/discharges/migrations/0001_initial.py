    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "discharge_date",
                    models.DateTimeField(help_text="Date and time of discharge"),
                ),
                (
                    "diagnosis",
                    models.TextField(help_text="Primary and secondary diagnoses"),
                ),
                (
                ...
                (
                    "treatment_summary",
                    models.TextField(help_text="Summary of treatment provided"),
                ),
                (
                ...
                (
                    ...
                    models.TextField(help_text="Follow-up care instructions"),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["visit"], name="discharge_s_visit_i_acc812_idx"
                    ),
                    models.Index(
                        fields=["consultation"], name="discharge_s_consult_83283b_idx"
                    ),
                    models.Index(
                        fields=["created_at"], name="discharge_s_created_2cdb77_idx"
                    ),
                ],
            },
        ),
