...
class DischargeSummary(models.Model):
    ...
    created_at = models.DateTimeField(
        auto_now_add=True, help_text="When the discharge summary was created"
    )

    updated_at = models.DateTimeField(
        auto_now=True, help_text="When the discharge summary was last updated"
    )
    ...
    def get_formatted_summary(self):
        ...
        lines.append(
            f"Discharge Date: {self.discharge_date.strftime('%Y-%m-%d %H:%M')}"
        )
        ...
        lines.append(
            f"Discharge Disposition: {self.get_discharge_disposition_display()}"
        )
