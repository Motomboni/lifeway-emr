...
class DischargeSummaryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Visit Information", {"fields": ("visit", "consultation", "created_by")}),
        (
            "Admission Details",
            {
                "fields": (
    ...
    def get_queryset(self, request):
        ...
        return qs.select_related(
            "visit", "consultation", "created_by", "visit__patient"
        )
...
class BedAdmin(admin.ModelAdmin):
    ...
    list_display = ["bed_number", "ward", "bed_type", "is_available", "is_active"]
...
class AdmissionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Visit Information", {"fields": ("visit", "admitting_doctor")}),
        ("Ward and Bed", {"fields": ("ward", "bed")}),
        (
            "Admission Details",
            {
                "fields": (
        ...
        ("Clinical Information", {"fields": ("chief_complaint", "admission_notes")}),
        ("Discharge Information", {"fields": ("discharge_date", "discharge_summary")}),
        ("Transfer Information", {"fields": ("transferred_from",)}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
