...
def log_discharge_action(
    user, action, visit_id, discharge_summary_id=None, request=None, metadata=None
):
    """
...
class DischargeSummaryViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        if DischargeSummary.objects.filter(visit=visit).exists():
            raise DRFValidationError("Discharge summary already exists for this visit.")
    ...
    def export_text(self, request, visit_id=None, pk=None):
        ...
        response["Content-Disposition"] = (
            f'attachment; filename="discharge_summary_{discharge_summary.visit_id}.txt"'
        )
        return response
...
<body>
    ...
    <div class="section">
        ...
        response["Content-Disposition"] = (
            f'attachment; filename="discharge_summary_{discharge_summary.visit_id}.html"'
        )
        return response
