...
class LoginOTP(models.Model):
    ...
    channel = models.CharField(
        max_length=20, choices=CHANNEL_CHOICES, help_text="Channel OTP was sent through"
    )

    recipient = models.CharField(
        max_length=255, help_text="Email or phone number OTP was sent to"
    )

    created_at = models.DateTimeField(
        auto_now_add=True, help_text="When OTP was generated"
    )
    ...
    used_at = models.DateTimeField(null=True, blank=True, help_text="When OTP was used")

    # Security tracking
    ip_address = models.GenericIPAddressField(
        null=True, blank=True, help_text="IP address that requested OTP"
    )
...
class LoginAuditLog(models.Model):
    ...
    action = models.CharField(
        max_length=50, choices=ACTION_CHOICES, help_text="Action that was performed"
    )

    identifier = models.CharField(
        max_length=255, blank=True, help_text="Email or phone used for login attempt"
    )
