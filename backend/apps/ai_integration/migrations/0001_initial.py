    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("automated_coding", "Automated Coding (ICD-10/CPT)"),
                ...
                (
                    "default_model",
                    models.CharField(
                        help_text="Default model for this feature", max_length=200
                    ),
                ),
                (
                    "enabled",
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["feature_type", "prompt_hash"],
                        name="ai_integrat_feature_632508_idx",
                    ),
                    models.Index(
                        fields=["expires_at"], name="ai_integrat_expires_eb5df5_idx"
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_role",
                    models.CharField(
                        help_text="Role of the user at time of request", max_length=50
                    ),
                ),
                (
                    "feature_type",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["visit", "-timestamp"],
                        name="ai_integrat_visit_i_4fa9ae_idx",
                    ),
                    models.Index(
                        fields=["user", "-timestamp"],
                        name="ai_integrat_user_id_9c2265_idx",
                    ),
                    models.Index(
                        fields=["feature_type", "-timestamp"],
                        name="ai_integrat_feature_dd09ee_idx",
                    ),
                    models.Index(
                        fields=["provider", "-timestamp"],
                        name="ai_integrat_provide_3157b3_idx",
                    ),
                ],
            },
        ),
