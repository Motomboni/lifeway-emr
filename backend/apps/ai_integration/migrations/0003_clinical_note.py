...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ai_generated_note",
                    models.TextField(
                        blank=True, help_text="AI-generated structured note"
                    ),
                ),
                (
                    "doctor_edited_note",
                    models.TextField(
                        blank=True, help_text="Final note after doctor edit/approval"
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["patient"], name="clinical_no_patient_6a8c0d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="clinicalnote",
            index=models.Index(
                fields=["doctor"], name="clinical_no_doctor__b2e8f2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="clinicalnote",
            index=models.Index(
                fields=["appointment"], name="clinical_no_appoint_9c4a1b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="clinicalnote",
            index=models.Index(
                fields=["note_type"], name="clinical_no_note_ty_2d4e5f_idx"
            ),
        ),
    ]
