...
from .models import AICache, AIConfiguration, AIFeatureType, AIProvider, AIRequest
...
class AIServiceFactory:
    ...
    @staticmethod
    def create_service(
        provider: AIProvider, model: str, api_key: Optional[str] = None
    ) -> AIServiceBase:
...
class AIServiceManager:
    ...
    def generate(
        self, prompt: str, use_cache: bool = True, cache_ttl: int = 3600, **kwargs
    ) -> Dict[str, Any]:
        """
