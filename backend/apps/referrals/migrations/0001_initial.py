        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "specialist_name",
                    models.CharField(
                        help_text="Name of the specialist or clinic", max_length=200
                    ),
                ),
                (
                    "specialist_contact",
                ...
                (
                    "specialist_notes",
                    models.TextField(blank=True, help_text="Notes from the specialist"),
                ),
                (
                    "created_at",
                    models.DateTimeField(
            ...
            options={
                ...
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["visit"], name="referrals_visit_i_e14793_idx"),
                    models.Index(
                        fields=["consultation"], name="referrals_consult_059cfc_idx"
                    ),
                    models.Index(fields=["status"], name="referrals_status_135a0e_idx"),
                    models.Index(
                        fields=["specialty"], name="referrals_special_d7d77c_idx"
                    ),
                    models.Index(
