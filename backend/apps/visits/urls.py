...
visit_scoped_urls = [
    ...
    path(
        "<int:visit_id>/payments/", include("apps.billing.urls"), name="visit-payments"
    ),
    ...
    path("<int:visit_id>/nursing/", include("apps.nursing.urls"), name="visit-nursing"),
    ...
    path(
        ...
        NurseMedicationAdministrationEndpoint.as_view(
    ...
    path(
        ...
        include(
            [
                path(
                    "",
                    AdmissionViewSet.as_view({"get": "list", "post": "create"}),
                    name="visit-admission-list",
                ),
                path(
                    "<int:pk>/",
                    AdmissionViewSet.as_view(
                        {
                            "get": "retrieve",
                            "put": "update",
                ...
                path(
                    "<int:pk>/discharge/",
                    AdmissionViewSet.as_view({"post": "discharge"}),
                    name="visit-admission-discharge",
                ),
                path(
                    "<int:pk>/transfer/",
                    AdmissionViewSet.as_view({"post": "transfer"}),
                    name="visit-admission-transfer",
                ),
            ]
        ),
    ...
    path("<int:visit_id>/ai/", include("apps.ai_integration.urls"), name="visit-ai"),
