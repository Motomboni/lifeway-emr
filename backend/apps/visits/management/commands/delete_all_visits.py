...
class Command(BaseCommand):
    help = (
        "Delete all Visit records from the database (cascade deletes related records)"
    )
    ...
    def handle(self, *args, **options):
        ...
        if visit_count == 0:
            self.stdout.write(
                self.style.SUCCESS(
                    "No visits found in the database. Nothing to delete."
                )
            )
            return
            ...
            with transaction.atomic():
                ...
                try:
                    ...
                    if radiology_order_count > 0:
                        ...
                        self.stdout.write(
                            f"  - Deleted {radiology_order_count} radiology order(s)"
                        )
                except ImportError:
                    pass
                ...
                try:
                    ...
                    if ma_count > 0:
                        ...
                        self.stdout.write(
                            f"  - Deleted {ma_count} medication administration(s)"
                        )
                ...
                try:
                    ...
                    if prescription_count > 0:
                        ...
                        self.stdout.write(
                            f"  - Deleted {prescription_count} prescription(s)"
                        )
                except ImportError:
                    pass
                ...
                if consultation_count > 0:
                    ...
                    self.stdout.write(
                        f"  - Deleted {consultation_count} consultation(s)"
                    )
                ...
                try:
                    ...
                    if telemedicine_count > 0:
                        ...
                        self.stdout.write(
                            f"  - Deleted {telemedicine_count} telemedicine session(s)"
                        )
                except ImportError:
                ...
                try:
                    ...
                    if ai_request_count > 0:
                        ...
                        self.stdout.write(
                            f"  - Deleted {ai_request_count} AI request(s)"
                        )
                except (ImportError, AttributeError):
                ...
                try:
                    ...
                    if ir_count > 0:
                        ...
                        self.stdout.write(
                            f"  - Deleted {ir_count} invoice/receipt document(s)"
                        )
                except (ImportError, AttributeError):
                    pass
