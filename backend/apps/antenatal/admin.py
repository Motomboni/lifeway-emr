...
class AntenatalRecordAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Patient Information", {"fields": ("patient", "pregnancy_number")}),
        (
            "Pregnancy Details",
            {
                "fields": (
        ...
        (
            "Outcome",
            {
                "fields": (
                    "outcome",
                    "delivery_date",
                    "delivery_gestational_age_weeks",
                    "delivery_gestational_age_days",
                )
            },
        ),
...
class AntenatalVisitAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        "antenatal_record__patient__first_name",
        "antenatal_record__patient__last_name",
    ]
    readonly_fields = ["created_at", "updated_at"]
...
class AntenatalLabAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        "test_name",
        "antenatal_visit__antenatal_record__patient__first_name",
    ]
    readonly_fields = ["created_at", "updated_at"]
