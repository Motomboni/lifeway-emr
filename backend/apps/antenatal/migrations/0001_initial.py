    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("PRIMIGRAVIDA", "Primigravida (First Pregnancy)"),
                            ("MULTIGRAVIDA", "Multigravida (2-4 Pregnancies)"),
                            (
                                "GRAND_MULTIGRAVIDA",
                                "Grand Multigravida (5+ Pregnancies)",
                            ),
                        ],
                        default="PRIMIGRAVIDA",
                ...
                (
                    ...
                    models.TextField(blank=True, help_text="Past surgical history"),
                ),
                (
                    "family_history",
                    models.TextField(
                ...
                (
                    "high_risk",
                    models.BooleanField(
                        default=False, help_text="High-risk pregnancy flag"
                    ),
                ),
                (
                    "risk_factors",
                ...
                (
                    "clinical_notes",
                    models.TextField(blank=True, help_text="General clinical notes"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "placenta_location",
                    models.CharField(
                        blank=True, help_text="Placenta location", max_length=50
                    ),
                ),
                (
                    "placenta_grade",
                ...
                (
                    "findings",
                    models.TextField(blank=True, help_text="Ultrasound findings"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "medication_name",
                    models.CharField(help_text="Name of medication", max_length=255),
                ),
                (
                    "category",
                    models.CharField(
                ...
                (
                    "dose",
                    models.CharField(
                        help_text="Dose (e.g., '200mg', '1 tablet')", max_length=100
                    ),
                ),
                (
                    "frequency",
                ...
                (
                    "end_date",
                    models.DateField(
                        blank=True, help_text="End date (if applicable)", null=True
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Notes about the medication"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "test_name",
                    models.CharField(help_text="Name of lab test", max_length=255),
                ),
                (
                    "test_date",
                    models.DateField(help_text="Date test was ordered/performed"),
                ),
                (
                    "hb",
                    models.DecimalField(
                ...
                (
                    "notes",
                    models.TextField(blank=True, help_text="Notes about the test"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="antenatal_r_patient_46ae24_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="antenatalrecord",
            index=models.Index(
                fields=["outcome", "-booking_date"],
                name="antenatal_r_outcome_df84d9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="antenatalvisit",
            index=models.Index(
                fields=["antenatal_record", "-visit_date"],
                name="antenatal_v_antenat_01cb75_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="antenatalvisit",
