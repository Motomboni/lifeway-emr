...
class OfflineDraft(models.Model):
    ...
    synced = models.BooleanField(
        default=False, help_text="Whether this draft has been synced"
    )

    synced_at = models.DateTimeField(
        null=True, blank=True, help_text="When the draft was synced"
    )
    ...
    created_at = models.DateTimeField(
        auto_now_add=True, help_text="When draft was created"
    )
...
class SyncQueue(models.Model):
    ...
    action_type = models.CharField(
        max_length=50, choices=ACTION_TYPES, help_text="Type of action to sync"
    )
    ...
    # Sync tracking
    synced_at = models.DateTimeField(
        null=True, blank=True, help_text="When the action was synced"
    )
    ...
    # Audit timestamps
    created_at = models.DateTimeField(
        auto_now_add=True, help_text="When sync item was created"
    )

    updated_at = models.DateTimeField(
        auto_now=True, help_text="When sync item was last updated"
    )
