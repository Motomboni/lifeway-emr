    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "draft_data",
                    models.JSONField(help_text="Draft data (encrypted, visit-scoped)"),
                ),
                (
                    "synced",
                    models.BooleanField(
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="When the draft was synced", null=True
                    ),
                ),
                (
                    "expires_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "action_data",
                    models.JSONField(help_text="Action data to sync (visit-scoped)"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "synced_at",
                    models.DateTimeField(
                        blank=True, help_text="When the action was synced", null=True
                    ),
                ),
                (
                    "error_message",
