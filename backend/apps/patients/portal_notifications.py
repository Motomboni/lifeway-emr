...
def send_portal_password_reset(
    patient, username: str, reset_token: str, reset_url: str
) -> Dict[str, any]:
    """
...
def send_portal_appointment_reminder(
    patient, appointment_datetime: str, doctor_name: str, clinic_location: str = ""
) -> Dict[str, any]:
    """
...
def send_lab_result_notification(
    patient, test_name: str, result_url: str
) -> Dict[str, any]:
    """
...
def _send_email(to: str, subject: str, body: str) -> bool:
    ...
    return send_transactional_email(to, subject, body, fail_silently=True)
