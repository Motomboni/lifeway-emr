...
def log_lab_catalog_action(user, action, test_id=None, request=None, metadata=None):
    """
...
class LabTestCatalogViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        test = serializer.save(organization=org) if org else serializer.save()
    ...
    def categories(self, request):
        ...
        categories = LabTestCatalog.objects.values_list(
            "category", flat=True
        ).distinct()
