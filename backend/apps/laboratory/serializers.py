...
class LabOrderCreateSerializer(serializers.ModelSerializer):
            ...
            if visit and tests_requested:
                try:
                    check_lab_order_duplicate(
                        visit=visit, test_code=tests_requested, window_minutes=5
                    )
    ...
    def create(self, validated_data):
        ...
        ordered_by = validated_data.pop("ordered_by", None) or (
        ...
        lab_order = LabOrder.objects.create(
            visit=visit, ordered_by=ordered_by, **validated_data
        )
