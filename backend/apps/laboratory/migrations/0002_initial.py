...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="laborder",
            index=models.Index(
                fields=["consultation"], name="lab_orders_consult_44b3bf_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="laborder",
        ...
        migrations.AddIndex(
            model_name="laborder",
            index=models.Index(
                fields=["ordered_by"], name="lab_orders_ordered_a815b3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="labresult",
            index=models.Index(
                fields=["lab_order"], name="lab_results_lab_ord_ce9a03_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="labresult",
            index=models.Index(
                fields=["recorded_by"], name="lab_results_recorde_ed8b78_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="labresult",
            index=models.Index(
                fields=["recorded_at"], name="lab_results_recorde_2479b2_idx"
            ),
        ),
    ]
