        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "test_name",
                    models.CharField(
                        help_text="Full name of the lab test", max_length=200
                    ),
                ),
                (
                    "category",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["test_code"], name="lab_test_ca_test_co_3bd3e2_idx"
                    ),
                    models.Index(
                        fields=["category"], name="lab_test_ca_categor_a2a45e_idx"
                    ),
                    models.Index(
                        fields=["is_active"], name="lab_test_ca_is_acti_fd7a85_idx"
                    ),
                    models.Index(
                        fields=["test_name"], name="lab_test_ca_test_na_5b0683_idx"
                    ),
                ],
            },
        ),
