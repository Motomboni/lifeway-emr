...
class TestChargeCreationEnforcement:
    ...
    def test_receptionist_can_create_misc_charge(self, receptionist_user, open_visit, api_client):
    ...
    def test_doctor_cannot_create_charge_via_api(self, doctor_user, open_visit, api_client):
        """Doctor should be denied from creating charges via API."""
        client = api_client(user=doctor_user, organization=open_visit.organization)
    ...
    def test_nurse_cannot_create_charge_via_api(self, nurse_user, open_visit, api_client):
    ...
    def test_charge_creation_requires_visit_open(self, receptionist_user, doctor_user, patient, api_client):
...
class TestInsuranceVisitScopeEnforcement:
    ...
    def test_insurance_is_visit_scoped(self, receptionist_user, open_visit, hmo_provider, api_client):
    ...
    def test_insurance_cannot_bypass_payment_enforcement(self, receptionist_user, open_visit, hmo_provider, doctor_user, api_client):
        ...
        # Try to create consultation (should fail - visit payment_status field is UNPAID)
        client = api_client(user=doctor_user, organization=open_visit.organization)
        ...
        assert response.status_code in [status.HTTP_403_FORBIDDEN, status.HTTP_400_BAD_REQUEST], \
            ...
            f"Consultation was created despite visit.payment_status='UNPAID'. " \
    ...
    def test_insurance_computation_is_visit_scoped(self, receptionist_user, open_visit, hmo_provider, api_client):
...
class TestWalletOverdraftPrevention:
    ...
    def test_wallet_cannot_debit_more_than_balance(self, receptionist_user, open_visit, wallet, api_client):
    ...
    def test_wallet_debit_via_api_prevents_overdraft(self, receptionist_user, open_visit, wallet, api_client):
        """Wallet debit via API should prevent overdraft."""
        client = api_client(user=receptionist_user, organization=open_visit.organization)
    ...
    def test_wallet_can_debit_exact_balance(self, receptionist_user, open_visit, wallet, api_client):
    ...
    def test_wallet_cannot_go_negative(self, receptionist_user, open_visit, wallet, api_client):
...
class TestPaystackVerificationEnforcement:
    ...
    def test_payment_intent_requires_verification(self, receptionist_user, open_visit, api_client):
    ...
    def test_payment_intent_verification_creates_payment(self, receptionist_user, open_visit, api_client):
    ...
    def test_unverified_payment_intent_cannot_be_used(self, receptionist_user, open_visit, api_client):
    ...
    def test_payment_intent_verification_is_idempotent(self, receptionist_user, open_visit, api_client):
...
class TestVisitClosureBalanceEnforcement:
    ...
    def test_visit_cannot_close_with_outstanding_balance(self, doctor_user, open_visit, receptionist_user, api_client):
    ...
    def test_visit_can_close_when_balance_cleared(self, doctor_user, open_visit, receptionist_user, api_client):
    ...
    def test_visit_can_close_with_insurance_full_coverage(self, doctor_user, open_visit, receptionist_user, hmo_provider, api_client):
        ...
        open_visit.payment_status = 'SETTLED'
        open_visit.save()
...
class TestBillingComputationAccuracy:
    ...
    def test_billing_computation_with_insurance_only(self, open_visit, receptionist_user, hmo_provider, api_client):
        ...
        assert summary.payment_status in ('UNPAID', 'INSURANCE_CLAIMED', 'INSURANCE_PENDING')
    
    def test_billing_computation_with_payment_only(self, open_visit, receptionist_user, api_client):
    ...
    def test_billing_computation_with_wallet_only(self, open_visit, receptionist_user, wallet, api_client):
    ...
    def test_billing_computation_with_insurance_and_payment(self, open_visit, receptionist_user, hmo_provider, api_client):
        ...
        assert summary.payment_status in ('PAID', 'SETTLED')
        assert summary.can_be_cleared is True
    
    def test_billing_computation_with_all_payment_methods(self, open_visit, receptionist_user, hmo_provider, wallet, api_client):
    ...
    def test_billing_computation_with_overpayment(self, open_visit, receptionist_user, api_client):
    ...
    def test_billing_computation_deterministic(self, open_visit, receptionist_user, hmo_provider, wallet, api_client):
