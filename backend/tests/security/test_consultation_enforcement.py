...
class TestConsultationAuthentication:
    ...
    def test_unauthenticated_create_denied(self, open_visit_with_payment, api_client):
    ...
    def test_unauthenticated_read_denied(self, open_visit_with_payment, api_client):
    ...
    def test_unauthenticated_update_denied(self, open_visit_with_payment, doctor_user, api_client):
        ...
        response = client.patch(url, {"history": "Updated history"})
...
class TestConsultationRoleEnforcement:
    ...
    def test_receptionist_cannot_create_consultation(self, receptionist_token, visit, api_client):
        ...
        assert (
            "doctor" in response.data.get("detail", "").lower()
    ...
    def test_pharmacist_cannot_create_consultation(self, pharmacist_token, visit, api_client):
...
class TestConsultationPaymentEnforcement:
    ...
    def test_consultation_blocked_if_payment_pending(self, doctor_token, unpaid_visit, api_client):
    ...
    def test_consultation_allowed_if_payment_cleared(self, doctor_token, visit, api_client):
    ...
    def test_consultation_update_blocked_if_payment_pending(
        self, doctor_token, unpaid_visit, doctor_user, api_client
    ):
        ...
        consultation = Consultation.objects.create(
            visit=unpaid_visit, created_by=doctor_user, history="Initial history"
        )
...
class TestConsultationVisitStatusEnforcement:
    ...
    def test_consultation_blocked_if_visit_closed(
        self, doctor_token, closed_visit_with_payment, api_client
    ):
    ...
    def test_consultation_update_blocked_if_visit_closed(
        self, doctor_token, closed_visit_with_payment, doctor_user, api_client
    ):
    ...
    def test_consultation_allowed_if_visit_open(self, doctor_token, visit, api_client):
...
class TestConsultationAuditLogging:
    ...
    def test_audit_log_created_on_create(self, doctor_token, visit, doctor_user, api_client):
    ...
    def test_audit_log_created_on_update(self, doctor_token, visit, doctor_user, api_client):
        """Audit log created when consultation is updated."""
        consultation = Consultation.objects.create(
            visit=visit, created_by=doctor_user, history="Initial history"
        )
    ...
    def test_audit_log_created_on_read(self, doctor_token, visit, doctor_user, api_client):
...
class TestConsultationVisitScoping:
    ...
    def test_consultation_requires_visit_id_in_url(self, doctor_token, api_client):
    ...
    def test_consultation_belongs_to_specific_visit(
        self, doctor_token, visit, doctor_user, api_client
    ):
...
class TestConsultationSuccessPath:
    ...
    def test_doctor_can_create_consultation_when_all_conditions_met(
        ...
        audit_log = AuditLog.objects.filter(
            action="consultation.create", visit_id=visit.id, user=doctor_user
        ).latest("timestamp")
