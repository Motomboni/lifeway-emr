...
class TestAIClinicalDecisionSupport:
    ...
    def test_doctor_can_access_ai_feature(self, doctor_token, open_visit_with_payment, doctor_user, api_client):
    ...
    def test_non_doctor_cannot_access_ai_feature(self, receptionist_token, open_visit_with_payment, api_client):
    ...
    def test_ai_feature_requires_payment_cleared(self, doctor_token, unpaid_visit, api_client):
    ...
    def test_ai_feature_requires_open_visit(self, doctor_token, closed_visit_with_payment, api_client):
...
class TestAIAuditLogging:
    ...
    def test_ai_request_logged(self, doctor_token, open_visit_with_payment, doctor_user, api_client):
