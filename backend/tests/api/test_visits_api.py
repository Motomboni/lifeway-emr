...
class TestVisitListAPI:
    ...
    def test_list_visits_authenticated(self, receptionist_token, visit, api_client):
    ...
    def test_list_visits_filter_by_status(self, receptionist_token, visit, api_client):
    ...
    def test_list_visits_filter_by_payment_status(self, receptionist_token, visit, api_client):
    ...
    def test_list_visits_pagination(self, receptionist_token, test_org, api_client):
...
class TestVisitCreateAPI:
    ...
    def test_create_visit_receptionist(self, receptionist_token, patient, api_client):
        """Test receptionist can create visit."""
        client = api_client(token=receptionist_token)

        data = {"patient": patient.id, "payment_status": "UNPAID"}
    ...
    def test_create_visit_invalid_patient(self, receptionist_token, api_client):
        """Test creating visit with invalid patient ID."""
        client = api_client(token=receptionist_token)

        data = {"patient": 99999, "payment_status": "UNPAID"}
...
class TestVisitRetrieveAPI:
    ...
    def test_retrieve_visit(self, receptionist_token, visit, api_client):
    ...
    def test_retrieve_nonexistent_visit(self, receptionist_token, api_client):
