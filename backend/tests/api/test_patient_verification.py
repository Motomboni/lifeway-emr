...
class TestPatientRegistration:
    ...
    def test_patient_registration_creates_unverified_account(self, receptionist_token, api_client):
...
class TestPendingVerificationAPI:
    ...
    def test_pending_verification_receptionist_access(
        self, receptionist_token, patient_with_user, api_client
    ):
    ...
    def test_pending_verification_non_receptionist_denied(
        self, doctor_token, patient_with_user, api_client
    ):
    ...
    def test_pending_verification_unauthenticated_denied(self, patient_with_user, api_client):
    ...
    def test_pending_verification_only_unverified(
        self, receptionist_token, patient_with_user, verified_patient, api_client
    ):
...
class TestPatientVerificationAPI:
    ...
    def test_verify_patient_receptionist(self, receptionist_token, patient_with_user, api_client):
    ...
    def test_verify_patient_non_receptionist_denied(
        self, doctor_token, patient_with_user, api_client
    ):
    ...
    def test_verify_patient_unauthenticated_denied(self, patient_with_user, api_client):
    ...
    def test_verify_patient_without_user_account(self, receptionist_token, patient, api_client):
    ...
    def test_verify_already_verified_patient(
        self, receptionist_token, verified_patient, api_client
    ):
    ...
    def test_verify_patient_creates_audit_log(
        self, receptionist_user, receptionist_token, patient_with_user, api_client
    ):
        """Test verification creates audit log entry."""
        client = api_client(token=receptionist_token)

        initial_log_count = AuditLog.objects.filter(
            action="PATIENT_VERIFIED", resource_id=patient_with_user.id
        ).count()
...
class TestPatientVerificationEmailNotification:
    ...
    def test_verification_sends_email_notification(
        self, receptionist_token, patient_with_user, api_client
    ):
...
class TestPatientPortalAccess:
    ...
    def test_unverified_patient_cannot_access_portal(self, patient_with_user, api_client):
    ...
    def test_verified_patient_can_access_portal(self, verified_patient, api_client):
